defmodule NoticiasWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NoticiasWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NoticiasWeb.Gettext, "errors", msg, opts)
    end
  end
